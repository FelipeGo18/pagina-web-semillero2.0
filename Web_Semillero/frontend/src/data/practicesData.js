    ...
    modules: [
      {
        ...
        description: "Historia, filosofía y distribuciones más populares de Linux.",
        duration: "30 min",
        difficulty: "Fácil"
      },
      {
        id: 2,
        title: "Comandos Básicos del Terminal",
        description: "Aprende comandos esenciales: ls, cd, mkdir, rm, cp, mv.",
        duration: "45 min",
        difficulty: "Fácil"
      },
      {
        ...
        description: "Comprende la estructura de directorios y el sistema de permisos.",
        duration: "1 hora",
      ...
      },
      {
        ...
        description: "Monitorea y administra procesos en Linux.",
        duration: "45 min",
        difficulty: "Intermedio"
      }
    ]
